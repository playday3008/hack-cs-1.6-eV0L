...
void StudioRenderModel(void)
{
	...
	Glow(ent, World, cvar.chams_world_glow, cvar.chams_world, cvar.color_green, cvar.color_blue, cvar.color_red, 12);
	Chams(ent, World, cvar.chams_world, cvar.chams_world_wall, cvar.color_blue, cvar.color_red, cvar.color_green, cvar.color_red, cvar.color_green, cvar.color_blue, chams_world, chams_world_r, chams_world_g, chams_world_b);
	Glow(ent, ViewModel, cvar.chams_view_model_glow, cvar.chams_view_model, cvar.color_blue, cvar.color_red, cvar.color_green, cvar.visual_no_hands?0:1);
	Chams(ent, ViewModel, cvar.chams_view_model, 0, cvar.color_blue, cvar.color_red, cvar.color_green, 0, 0, 0, chams_viewmodel, chams_viewmodel_r, chams_viewmodel_g, chams_viewmodel_b);
	...
	if (ent)
	{
		...
		Chams(ent, Player, cvar.chams_player, cvar.chams_player_wall && cvar.skeleton_models != 1, r[0], g[0], b[0], r[1], g[1], b[1], chams_player, chams_player_r, chams_player_g, chams_player_b);
	}
...
void StudioRenderFinal_Hardware(void)
{
	...
	bool Player = ent && ent->player && (g_Player[ent->index].iTeam != g_Local.iTeam || cvar.visual_visual_team);
	if (Player && cvar.skeleton_models == 1 && CheckDrawEngine())
		g_pStudio->StudioDrawBones();

	if (Player && cvar.skeleton_models == 2 && CheckDrawEngine())
